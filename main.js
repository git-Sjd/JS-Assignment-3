...
//   <div class="card">
//             <div><img src="https://assets.myntassets.com/h_1440,q_100,w_1080/v1/assets/images/7579188/2018/11/5/08a7b230-ee8f-46c0-a945-4e835a3c01c01541402833619-United-Colors-of-Benetton-Men-Sweatshirts-1271541402833444-1.jpg" alt="Blue_Sweatshirt"></div>
//             <div>
//                 <p>Men Navy Blue Solid Sweatshirt</p>
...
//   </div>
  ...
  clothingSection.className="card-container"
...
//     for(item of productList){
        // var cardWraper = document.createElement("div");
        // cardWraper.className="card"


        // var imageWraper = document.createElement("div")
        // imageWraper.className="image-section"
        ...
        // productCompany.innerText=item.brand
...
//         cardWraper.append(imageWraper, textWraper)


//         if(item.isAccessory === true){
//             assoceriseSection.append(cardWraper)
//         }
//         else{
//             clothingSection.append(cardWraper)
//         }
//     }
//   }
